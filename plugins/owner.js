...
let handler = async(m, { conn, text, usedPrefix, command }) => {
    ...
    orderTitle: ``,
    thumbnail: await conn.resize(await (await fetch('https://telegra.ph/file/a8794a33c028e17f0e0e6.jpg')).buffer(), 300, 200) //Gambarnye
...
let cap = `Hay kak @${await m.sender.split('@')[0]}, itu nomor ownerku jangan dispam yah ^_^` 
  let buttonMessage= {
'document':{'url':'https://youtu.be/ALQiRR1nzLI'},
...
'caption':cap,
'footer':`Itu Owner Ku Yah Kak Jangan Sungkem Untuk Chat Tapi jangan aneh aneh yah kak nanti di marahin neng amell loh ;3
